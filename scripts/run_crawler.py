"""STEP2: 네이버 부동산 크롤링 실행 스크립트.

사용 예시:
    python scripts/run_crawler.py --max-items 50 --output data/raw_listings.json
"""
